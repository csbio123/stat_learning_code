...
prepare_feature_sets<-function(data_list, outptut_dir, prefix="dataset") {
  ...
  technical_cofounders = subset(data_list$hba_enet, select=c(sv1, sv2, sv3, sv4, sv5, sv6, sv7, sv8, sv9, sv10, sv11, sv12, sv13, sv14, sv15))
...
prepared_data = prepare_feature_sets(data_list, outptut_dir = "/users/spjtcoi/brc_scratch/project_tomi/conrad/reanalyse/drug_naive/new_protocol_25thOct/PREDICTION/validation_input/hba")
