...
prepare_feature_sets<-function(data_list, outptut_dir, prefix="dataset") {
  ...
  gene_expression =data_list$hba_enet[,61:ncol(data_list$bmi_enet)]
...
prepared_data = prepare_feature_sets(data_list, outptut_dir = "C:/Users/spjtcoi/Google Drive/conrad/dataset2_chronic_scz/inputfiles_for_validation/hba/")
names(prepared_data)
