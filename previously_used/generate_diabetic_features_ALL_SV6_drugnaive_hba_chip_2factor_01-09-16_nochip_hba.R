...
prepare_feature_sets<-function(data_list, outptut_dir, prefix="dataset") {
  ...
  technical_cofounders = subset(data_list$hba_enet, select=c(Timepoint, sv1, sv2, sv3, sv4, sv5, sv6))
...
prepared_data = prepare_feature_sets(data_list, outptut_dir = "/users/spjtcoi/brc_scratch/project_tomi/conrad/reanalyse/drug_naive/new_protocol_25thOct/IMPUTATION_SETS/input_files_HBA_2catg_nochips")
names(prepared_data)
