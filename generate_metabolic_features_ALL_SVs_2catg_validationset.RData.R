...
input_data=read_data("/Users/ti1/Google Drive/raw data/", "generate_metabolic_features_ALL_SVs_2catg_validationset.RData")
...
prepared_data = prepare_feature_sets(data_list, outptut_dir = "/Users/ti1/Google Drive/raw data/validation_data")
names(prepared_data)
