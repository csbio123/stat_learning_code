...
training_input=${input_dir}/COMBAT/train_combat/training_set_${SGE_TASK_ID}.csv
test_input=${input_dir}/COMBAT/validation_combat/validation_set_${SGE_TASK_ID}.csv
training_GE=${input_dir}/COMBAT/train_combat/training_set_gene_expression.csv
test_GE=${input_dir}/COMBAT/validation_combat/validation_set_gene_expression.csv
feature_list=${input_dir}/FEATURES/validation_features_WGCNA_ComBat.csv

remove_feature_list=${input_dir}/REMOVE/ComBat_rm_features/leave_one_out/remove_demographic.txt #If no removals then add random (null) filename.Will be ignored

output_dir=/users/spjtcoi/brc_scratch/project_tomi/conrad/reanalyse/drug_naive/new_protocol_25thOct/WGCNA/continuous_BMI/COMBAT/remove_demographic
