...
remove_feature_list=${input_dir}/REMOVE/SVA_rm_features/colour_by_colour/BROWN_only.txt/ #If no removals then add random (null) filename.Will be ignored

output_dir=/users/spjtcoi/brc_scratch/project_tomi/conrad/reanalyse/drug_naive/new_protocol_25thOct/WGCNA/continuous_BMI/SVA/BROWN_only
