...
remove_feature_list=${input_dir}/../medical_only.txt #If nothing to remove then add random (null) filename which will be ignored
output_dir=/users/spjtcoi/git/stat_learning_code/metabolics/validation_prediction_new/batch_normalized_data/output_medical_only2/
