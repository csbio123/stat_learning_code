...
remove_feature_list=${input_dir}/REMOVE/ComBat_rm_features/colour_by_colour/PINK_only.txt/ #If no removals then add random (null) filename.Will be ignored

output_dir=/users/spjtcoi/brc_scratch/project_tomi/conrad/reanalyse/drug_naive/new_protocol_25thOct/WGCNA/continuous_BMI/COMBAT/PINK_only
