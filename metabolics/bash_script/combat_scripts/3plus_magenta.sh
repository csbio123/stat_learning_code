...
remove_feature_list=${input_dir}/REMOVE/ComBat_rm_features/3plus_1color/3plus_magenta.txt/ #If no removals then add random (null) filename.Will be ignored

output_dir=/users/spjtcoi/brc_scratch/project_tomi/conrad/reanalyse/drug_naive/new_protocol_25thOct/WGCNA/continuous_BMI/COMBAT/3plus_magenta
